...
the same license as CADD Stat. Please run the test suite before submitting a pull request::

  python runtests.py
  # or
  python setup.py test

Test against multiple django versions use ``tox``.

Development
-----------

To create suitable development environment in a virtualenv run ``pip install -r requirements.txt``.
...
* Inspiration for the django app layout taken from `django-app-template <https://github.com/mlavin/django-app-template>`_.
